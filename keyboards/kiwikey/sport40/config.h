...
#define QUANTUM_PAINTER_PIXDATA_BUFFER_SIZE	57600	//The limit of the amount of pixel data that can be transmitted in one transaction to the display. Higher values require more RAM on the MCU.
