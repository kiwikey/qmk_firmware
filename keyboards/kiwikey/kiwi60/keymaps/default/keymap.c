...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
		...
		KC_LSHIFT,	KC_BSLS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLASH,    KC_RSHIFT,   MO(_FN),
		KC_LCTRL,	KC_LWIN, KC_LALT,						     KC_SPC,					KC_RALT, MO(_FN), KC_LWIN,     KC_APP,     	KC_LCTRL
    ),
	[_FN] = LAYOUT(
