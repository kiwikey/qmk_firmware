...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   KC_MUTE,  LWIN(KC_D), KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
  ...
  [3] = LAYOUT(
        ...
        RGB_MOD, RGB_HUI, RGB_VAI, RGB_SPI, _______, _______,                   _______, _______, _______, _______, _______, _______,
        RGB_RMOD,RGB_HUD, RGB_VAD, RGB_SPD, _______, _______,                   _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
