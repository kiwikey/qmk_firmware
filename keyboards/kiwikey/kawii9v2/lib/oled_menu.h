...
#define EEPROM_LAYER_COLOR00   (VIA_EEPROM_CUSTOM_CONFIG_ADDR+4)
#define EEPROM_LAYER_COLOR01   (VIA_EEPROM_CUSTOM_CONFIG_ADDR+5)
#define EEPROM_LAYER_COLOR02   (VIA_EEPROM_CUSTOM_CONFIG_ADDR+6)
#define EEPROM_LAYER_COLOR03   (VIA_EEPROM_CUSTOM_CONFIG_ADDR+7)
#define EEPROM_LAYER_COLOR04   (VIA_EEPROM_CUSTOM_CONFIG_ADDR+8)
