...
#define EEPROM_LAYER_COLOR00   (VIA_EEPROM_CUSTOM_CONFIG_ADDR+4)  // not used
#define EEPROM_LAYER_COLOR01   (VIA_EEPROM_CUSTOM_CONFIG_ADDR+5)  // not used
#define EEPROM_LAYER_COLOR02   (VIA_EEPROM_CUSTOM_CONFIG_ADDR+6)  // not used
#define EEPROM_LAYER_COLOR03   (VIA_EEPROM_CUSTOM_CONFIG_ADDR+7)  // not used
#define EEPROM_LAYER_COLOR04   (VIA_EEPROM_CUSTOM_CONFIG_ADDR+8)  // not used

// #define EEPROM_LAYER_COLOR00   (VIA_EEPROM_CUSTOM_CONFIG_ADDR+9)  // not used
// #define EEPROM_LAYER_COLOR01   (VIA_EEPROM_CUSTOM_CONFIG_ADDR+10) // not used
// #define EEPROM_LAYER_COLOR02   (VIA_EEPROM_CUSTOM_CONFIG_ADDR+11) // not used
// #define EEPROM_LAYER_COLOR03   (VIA_EEPROM_CUSTOM_CONFIG_ADDR+12) // not used
// #define EEPROM_LAYER_COLOR04   (VIA_EEPROM_CUSTOM_CONFIG_ADDR+13) // not used
