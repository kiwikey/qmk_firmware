...
static const pin_t row_pins[MATRIX_ROWS / 2] = { D2, D3, D4, D5, D6 };
static const pin_t col_pins[MATRIX_COLS]     = { E6, F0, F1, F4, F5, F6, F7 };
...
static void init_pins_MCP23018(void) {
    ...
    mcp23018_errors += !mcp23018_set_config(I2C_ADDR, mcp23018_PORTB, 0b00000000);
}
